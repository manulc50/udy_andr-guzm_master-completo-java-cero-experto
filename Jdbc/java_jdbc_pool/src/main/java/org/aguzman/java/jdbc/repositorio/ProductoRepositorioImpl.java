...
// En este caso, para cada operación sobre la base de datos, se usa una conexión distinta de un pool de conexiones
// En este caso, el método privado "getConnection" devuelve una conexión disponible a la base de datos del pool de conexiones
// En esta caso, como estamos usando conexiones de un pool, cuando un bloque "try-with-resources" invoca al método "close" de una conexión(objeto de tipo "Connection"), realmente no se cierra esa conexión, sino que se libera en el pool de conexiones
...
public class ProductoRepositorioImpl implements Repositorio<Producto> {
    ...
    // Método que devuelve una conexión disponible a la base de datos del pool de conexiones
