...
@WebServlet({"/productos.xls", "/productos.html", "/productos"}) // En este caso, ".xls" y ".html" forman parte del nombre de las rutas del servlet. No son extensiones de archivos XLS o archivos "HTML"
public class ProductoXlsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean esXls = req.getServletPath().endsWith(".xls");
        if(esXls) {
