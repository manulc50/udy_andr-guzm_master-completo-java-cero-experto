...
public class HibernateAsociacionesOneToOne {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Se comenta porque ahora la dueña de la relación es la clase entidad "Cliente"
            //clienteDetalle.setCliente(cliente); // Válido si la clase entidad "ClienteDetalle" es la dueña de la relación y, por lo tanto, contiene una propiedad de tipo "Cliente" anotada con "@OneToOne"
