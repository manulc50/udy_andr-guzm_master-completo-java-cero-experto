...
public class HibernateAsociacionesManyToManyFindBidireccional {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Transacción que crea o localiza 2 alumnos de la base de datos, también localiza 2 cursos de la base de datos y los relaciona
            ...
            Curso c3 = new Curso("Curso React", "Francisco"); // El título del curso y el nombre del profesor no influye para realizar la eliminación de ese curso del alumno. La propiedad del curso que importa es el id ya que es la propiedad que se usa en el método "equals"
            c3.setId(2L);
